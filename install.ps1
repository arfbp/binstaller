# Set lokasi dan URL
$batUrl    = 'https://file.mocina.my.id/upload/installer.bat'
$batFile   = "$env:TEMP\installer.bat"

$aria2ZipUrl  = 'https://file.mocina.my.id/upload/aria2c.exe' #ini diganti ya ges, gapake yg zip lagi  tp variable nya sama
